          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="text-gray-400 mb-4">
                Le site Traxxio est édité par la société Traxxio SAS, société par actions simplifiée au capital de 10 000 euros,
            ...
            <section>
              ...
              <p className="text-gray-400 mb-4">
                L'ensemble du contenu du site Traxxio (textes, images, vidéos, etc.) est protégé par le droit d'auteur.
            ...
            <section>
              ...
              <p className="text-gray-400 mb-4">
                Le site Traxxio utilise des cookies pour améliorer l'expérience utilisateur. En navigant sur ce site,
            ...
            <section>
              ...
              <p className="text-gray-400 mb-4">
                Traxxio s'efforce d'assurer l'exactitude et la mise à jour des informations diffusées sur ce site.
